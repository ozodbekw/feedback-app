...
function Home() {
  return (
    <div className="font-jost mx-auto w-full flex gap-[30px] container xl:flex-row md:flex-col">
      <Header />
      <div>
        ...
        <div className="navbar bg-[#373F68] py-[23px] pl-6 pr-4 rounded-[10px] w-full justify-between ">
